...
Character::Character(float px, float py, int textRect_width, int textRect_height, int textRect_top, int textRect_left, int hitbox_x, int hitbox_y, int hitbox_largeur, int hitbox_hauteur, std::string texture, Scene* scene) :
	Entite (px, py, textRect_width,  textRect_height,  textRect_top,  textRect_left, hitbox_x,  hitbox_y,  hitbox_largeur,  hitbox_hauteur, texture, scene), m_spx(px), m_spy(py)
{
	setMode("exploration");
	m_type = "Character";
}
...
void Character::test_poly() const
{
    std::cout << "Je suis un character" << std::endl;
}
